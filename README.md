...
- Safe antialiasing and intentional R/G gradients in `Auto` mode; strict 0.1.x decoding remains available.
...
- One dirty-only compositor and one final `_AlphaMask`; simultaneous sources use maximum hide coverage.
