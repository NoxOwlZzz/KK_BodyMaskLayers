...
for %%F in (mscorlib.dll System.dll System.Core.dll System.Xml.dll Assembly-CSharp.dll Assembly-CSharp-firstpass.dll UnityEngine.dll UnityEngine.UI.dll) do (
